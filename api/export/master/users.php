...
$config = [
    ...
    'columns'   => [
        ...
        ['field' => 'zone_code',          'header' => '管轄ゾーンコード',           'type' => 'string'],
        ['field' => 'area_code',          'header' => '管轄エリアコード',           'type' => 'string'],
        ['field' => 'password',           'header' => 'パスワード',                 'type' => 'string'],
        ['field' => 'zone_manager_email', 'header' => 'ゾーンマネージャーメールアドレス', 'type' => 'string'],
        ['field' => 'area_manager_email', 'header' => 'エリアマネージャーメールアドレス', 'type' => 'string'],
