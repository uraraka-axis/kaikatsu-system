    ...
    // ~101% over-budget
    var rO  = [1.05,1.08,0.98,1.12,1.03,1.10,0.95,1.06,1.09,1.02,1.07,0.80];
    var rO2 = [1.02,1.06,0.96,1.10,1.01,1.08,0.93,1.04,1.07,1.00,1.05,0.78];
    // ~80% medium
    ...
    // 新宿東口: 101%+ over-budget!
    addStore('2026','10301:新宿東口','100','103','10301', md(30000,rO), md(22000,rO2));
    // 池袋西口: ~90% high
