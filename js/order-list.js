  ...
  if (action === 'order') {
    ...
    if (order.type === 'equipment') {
      ...
      body.innerHTML =
        ...
        '<div class="modal-row"><span class="modal-label">納品日</span><input class="modal-input" id="modalActualDeliveryDate" type="date"><div style="font-size:11px;color:#94a3b8;margin-top:2px;">未入力なら納品済時の納品日</div></div>' +
        '<div class="modal-row"><span class="modal-label">メモ</span><textarea class="modal-textarea" id="modalMemo" placeholder="任意入力"></textarea></div>';
    } else {
