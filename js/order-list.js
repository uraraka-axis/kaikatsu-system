    ...
    function renderOrders() {
      ...
      filtered.forEach(function(o) {
        ...
        if (o.type === 'repair') {
          ...
          html += '<div class="detail-grid">' +
            '<div class="detail-item"><div class="detail-label">部品名・品番</div><div class="detail-value">' + (o.partsName || '') + '</div></div>' +
            '<div class="detail-item"><div class="detail-label">対象機材</div><div class="detail-value">' + (o.targetEquip || '') + '</div></div>' +
            '<div class="detail-item"><div class="detail-label">数量</div><div class="detail-value">' + (o.quantity || 1) + '</div></div>' +
            '<div class="detail-item"><div class="detail-label">発注理由・備考</div><div class="detail-value">' + (o.reason || '') + '</div></div>' +
          '</div>';
          if (o.partsPhotos && o.partsPhotos > 0) {
            html += '<div class="photo-section"><div class="detail-label">写真（' + o.partsPhotos + '枚）</div><div class="photo-grid">';
            for (var pp = 0; pp < o.partsPhotos; pp++) {
              html += '<div class="photo-placeholder"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" width="24" height="24"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg><span>写真 ' + (pp + 1) + '</span></div>';
            }
            html += '</div></div>';
          }
        }
